...
class VenueDetailActivity : BaseActivity() {
    ...
    override fun init_title() {
        ...
        venue_detail_banner.setOnItemClickListener { position -> }
        ...
        OkGo.post<String>(BaseHttp.venue_details)
                ...
                .execute(object : StringDialogCallback(baseContext) {
                    ...
                    override fun onSuccessResponse(response: Response<String>, msg: String, msgCode: String) {
                        ...
                        venue_detail_title.text = obj.getString("venueName")
                        venue_detail_scan.text = "浏览（${obj.getString("readCount")}）"
                        venue_detail_addr.text = "地址：" + obj.getString("venueName")

                        val imgs = obj.getString("venueHead").split(",")
                        ...
                        val info = obj.getString("introduce")
